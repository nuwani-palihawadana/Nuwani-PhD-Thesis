...
\hypersetup{
  pdftitle={Optimal Predictor Selection for High-dimensional Nonparametric Forecasting},
  pdfauthor={Nuwani Kodikara Palihawadana},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\clubpenalty = 2000
\widowpenalty = 2000
\usepackage{microtype}\usepackage{bm}
\def\maketitle{
\pagenumbering{roman}
{\sf\thispagestyle{empty}%
  ...
  \begin{center}\fontsize{24}{28}\sf
     \textbf{Optimal Predictor Selection for High-dimensional
Nonparametric Forecasting}\\[2cm]
     \fontsize{18}{20}\sf Nuwani Kodikara Palihawadana\\[0.2cm]
     \fontsize{13}{15}\sf B.Sc. (Hons), University of Colombo, Sri Lanka
     \vfill
...
\title{Optimal Predictor Selection for High-dimensional Nonparametric
Forecasting}
\date{}
\begin{document}
\maketitle
...
Produced on 20 August 2024.

© Nuwani Kodikara Palihawadana (2024).
...
\caption{\label{tbl-simulation}Simulation experiment results showing the
index structures and test MSE values (in parentheses below) of the
estimated SMI models with different initialisations for each combination
of response, input predictors, and noise levels.}
...
\toprule
\textbf{Model} & \textbf{Predictors} & \textbf{PPR} & \textbf{Additive} & \textbf{Linear} & \textbf{Multiple}\\
\midrule
\addlinespace[0.6em]
\multicolumn{6}{l}{\textbf{Low noise level}}\\
\hspace{1em}$y_{t}$ & all $\bm{x}$ & ($x_{0,t}, x_{1,t}, x_{3,t}$) & ($x_{0,t}, x_{1,t}, x_{3,t}$) & ($x_{0,t}, x_{1,t}, x_{3,t}$) & ($x_{0,t}, x_{1,t}, x_{3,t}$)\\
\hspace{1em} &  & ($0.009$) & ($0.009$) & ($0.009$) & \vphantom{1} ($0.009$)\\
\hspace{1em}$y_{t}$ & all $\bm{x}$ + all $\bm{z}$ & ($x_{0,t}, x_{1,t}, x_{3,t}$) & ($x_{0,t}, x_{1,t}, x_{3,t}$) & ($x_{0,t}, x_{1,t}, x_{3,t}$) & ($x_{0,t}, x_{1,t}, x_{3,t}$)\\
\hspace{1em} &  & ($0.009$) & ($0.009$) & ($0.009$) & ($0.009$)\\
\hspace{1em}$y_{t}$ & some $\bm{x}$ + all $\bm{z}$ & ($x_{0,t}, x_{1,t}, z_{2,t}, z_{4,t}$) & ($x_{0,t}, x_{1,t}$) ($z_{4,t}$) ($z_{1,t}$) & ($x_{0,t}, x_{1,t}, z_{2,t}, z_{4,t}$) & ($x_{0,t}, x_{1,t}, z_{2,t}, z_{4,t}$)\\
\hspace{1em} &  & ($0.233$) & ($0.235$) & ($0.233$) & ($0.233$)\\
[1.6em]
\hspace{1em}$w_{t}$ & all $\bm{x}$ & ($x_{0,t}, x_{1,t}, x_{3,t}$) ($x_{2,t}, x_{5,t}$) & ($x_{0,t}, x_{1,t}, x_{3,t}$) ($x_{2,t}, x_{5,t}$) & ($x_{0,t}, x_{1,t}, x_{2,t}, x_{3,t}, x_{5,t}$) & ($x_{0,t}, x_{1,t}, x_{3,t}$) ($x_{2,t}, x_{5,t}$)\\
\hspace{1em} &  & ($0.157$) & ($0.157$) & ($0.158$) & \vphantom{1} ($0.157$)\\
...
\includegraphics{02-chap2_files/figure-pdf/fig-deaths-1.pdf}
...
\includegraphics{02-chap2_files/figure-pdf/fig-Tmax-1.pdf}
...
other two estimated SMI models. Table~\ref{tbl-heat} also shows that
\textbf{\emph{SMI Model (5, 12) - PPR}} outperforms all three benchmark
models in terms of forecasting accuracy, for both \emph{Test Set 1} and
\emph{Test Set 2}. However, the SMI models estimated using ``Additive''
or ``Linear'' initialisations have inferior forecasting performance
compared to GAIM and PPR models.

\begin{table}[!hb]

\caption{\label{tbl-heat}Out-of-sample point forecast results for daily
mortality in summer. The columns \emph{Model}, \emph{Predictors} and
...
\includegraphics{02-chap2_files/figure-pdf/fig-solar-1.pdf}
...
\includegraphics{02-chap2_files/figure-pdf/fig-preds-1.pdf}
